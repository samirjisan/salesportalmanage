...
<div class="limiter">
    ...
    <div class="container-login100" style="background-image: url('/image/orbit2.jpeg');">
        <div class="wrap-login100 p-t-30 p-b-50">
            ...
            <form action="{{ route('admin.register') }}" method="POST" class="login100-form validate-form p-b-33 p-t-5">
                {{ csrf_field() }}
                ...
                <div class="container-login100-form-btn m-t-32">
                    <p>    Already Registered In System?
                        <a href="{{ route('admin.login') }}" button  class="login100-form-btn">
                            Login
                            </button>
                        </a></p>
                </div>
