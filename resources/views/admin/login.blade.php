...
<div class="limiter">
        ...
        <div class="container-login100" style="background-image: url('/image/admin/orbit2.jpeg');">
    {{--<div class="container-login100" style="background-image: url('image/orbit.jpeg');">--}}
        <div class="wrap-login100 p-t-30 p-b-50">
            ...
            <form action="{{ route('admin.login') }}" method="POST" class="login100-form validate-form p-b-33 p-t-5">
                ...
                <div class="container-login100-form-btn m-t-32">
                    <a href="{{ route('user.register') }}" button  class="login100-form-btn">
                        Register
                        </button>
                    </a>
                </div>
                ...
                @if(session('loginRequest'))
                    <p style="color:red;">{{ session('loginRequest') }}</p>
                @endif
